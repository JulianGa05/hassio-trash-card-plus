...
| `label_font_size` | number (%) | `100` | Font size of the trash type label. |
| `date_font_size` | number (%) | `100` | Font size of the date line. |
| `counter_font_size` | number (%) | `100` | Font size of the days-until counter. |
